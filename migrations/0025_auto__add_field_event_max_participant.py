...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.max_participant'
        db.add_column(u'OneEvent_event', 'max_participant',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.max_participant'
        db.delete_column(u'OneEvent_event', 'max_participant')
