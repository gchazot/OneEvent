...
urlpatterns = patterns(
    ...
    url(r'^dl_event_options_summary/(?P<event_id>\d+)/$', 'dl_event_options_summary',
        name='dl_event_options_summary'),
    url(r'^dl_participants_list/(?P<event_id>\d+)/$', 'dl_participants_list',
        name='dl_participants_list'),
    url(r'^confirm_payment/(?P<booking_id>\d+)/$', 'confirm_payment', name='confirm_payment'),
    url(r'^cancel_payment/(?P<booking_id>\d+)/$', 'confirm_payment',
