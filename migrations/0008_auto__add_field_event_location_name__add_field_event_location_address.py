...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'OneEvent_event', 'location_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.location_address'
        db.add_column(u'OneEvent_event', 'location_address',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'OneEvent_event', 'location_name')

        # Deleting field 'Event.location_address'
        db.delete_column(u'OneEvent_event', 'location_address')
