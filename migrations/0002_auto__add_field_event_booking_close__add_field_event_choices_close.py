...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.booking_close'
        db.add_column(u'OneEvent_event', 'booking_close',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.choices_close'
        db.add_column(u'OneEvent_event', 'choices_close',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.booking_close'
        db.delete_column(u'OneEvent_event', 'booking_close')

        # Deleting field 'Event.choices_close'
        db.delete_column(u'OneEvent_event', 'choices_close')
