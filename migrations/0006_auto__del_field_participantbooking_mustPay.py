...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field employees_groups on 'Event'
        db.create_table(u'OneEvent_event_employees_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'OneEvent.event'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'OneEvent_event_employees_groups', ['event_id', 'group_id'])

        # Adding M2M table for field contractors_groups on 'Event'
        db.create_table(u'OneEvent_event_contractors_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'OneEvent.event'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'OneEvent_event_contractors_groups', ['event_id', 'group_id'])

        # Deleting field 'ParticipantBooking.mustPay'
        db.delete_column(u'OneEvent_participantbooking', 'mustPay')


    def backwards(self, orm):
        # Removing M2M table for field employees_groups on 'Event'
        db.delete_table('OneEvent_event_employees_groups')

        # Removing M2M table for field contractors_groups on 'Event'
        db.delete_table('OneEvent_event_contractors_groups')

        # Adding field 'ParticipantBooking.mustPay'
        db.add_column(u'OneEvent_participantbooking', 'mustPay',
    ...
    models = {
        u'OneEvent.event': {
            ...
            'contractors_groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'contractors_for_event+'", 'symmetrical': 'False', 'to': u"orm['auth.Group']"}),
            'employees_groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'employees_for_event+'", 'symmetrical': 'False', 'to': u"orm['auth.Group']"}),
