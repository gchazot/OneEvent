...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventChoiceOption.description'
        db.delete_column(u'OneEvent_eventchoiceoption', 'description')

        # Deleting field 'EventChoice.description'
        db.delete_column(u'OneEvent_eventchoice', 'description')

        # Adding field 'Event.description'
        db.add_column(u'OneEvent_event', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventChoiceOption.description'
        db.add_column(u'OneEvent_eventchoiceoption', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EventChoice.description'
        db.add_column(u'OneEvent_eventchoice', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Event.description'
        db.delete_column(u'OneEvent_event', 'description')
    ...
    models = {
        ...
        u'OneEvent.eventchoice': {
            'Meta': {'ordering': "['id']", 'unique_together': "(('event', 'title'),)", 'object_name': 'EventChoice'},
        ...
        u'OneEvent.eventchoiceoption': {
            'Meta': {'ordering': "['choice__id', 'id']", 'unique_together': "(('choice', 'title'),)", 'object_name': 'EventChoiceOption'},
        ...
        u'OneEvent.participantbooking': {
            'Meta': {'ordering': "['id']", 'unique_together': "(('event', 'person'),)", 'object_name': 'ParticipantBooking'},
        ...
        u'OneEvent.participantoption': {
            'Meta': {'ordering': "['option__choice__id', 'option__id', 'id']", 'unique_together': "(('booking', 'option'),)", 'object_name': 'ParticipantOption'},
