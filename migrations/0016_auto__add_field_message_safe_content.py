...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.safe_content'
        db.add_column(u'OneEvent_message', 'safe_content',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.safe_content'
        db.delete_column(u'OneEvent_message', 'safe_content')
