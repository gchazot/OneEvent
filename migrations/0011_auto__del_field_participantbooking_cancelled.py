...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParticipantBooking.cancelled'
        db.delete_column(u'OneEvent_participantbooking', 'cancelled')


    def backwards(self, orm):
        # Adding field 'ParticipantBooking.cancelled'
        db.add_column(u'OneEvent_participantbooking', 'cancelled',
