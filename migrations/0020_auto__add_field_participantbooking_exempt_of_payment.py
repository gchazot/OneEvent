...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantBooking.exempt_of_payment'
        db.add_column(u'OneEvent_participantbooking', 'exempt_of_payment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipantBooking.exempt_of_payment'
        db.delete_column(u'OneEvent_participantbooking', 'exempt_of_payment')
