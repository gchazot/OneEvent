...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.pub_status'
        db.add_column(u'OneEvent_event', 'pub_status',
                      self.gf('django.db.models.fields.CharField')(default='PUB', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.pub_status'
        db.delete_column(u'OneEvent_event', 'pub_status')
