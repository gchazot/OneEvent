...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantBooking.confirmedOn'
        db.add_column(u'OneEvent_participantbooking', 'confirmedOn',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipantBooking.confirmedOn'
        db.delete_column(u'OneEvent_participantbooking', 'confirmedOn')
