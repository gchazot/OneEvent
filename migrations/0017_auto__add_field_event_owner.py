...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'OneEvent_event', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='events_owned', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.owner'
        db.delete_column(u'OneEvent_event', 'owner_id')
