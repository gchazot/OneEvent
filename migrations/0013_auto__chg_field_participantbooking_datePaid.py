...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParticipantBooking.datePaid'
        db.alter_column(u'OneEvent_participantbooking', 'datePaid', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ParticipantBooking.datePaid'
        db.alter_column(u'OneEvent_participantbooking', 'datePaid', self.gf('django.db.models.fields.DateField')(null=True))
