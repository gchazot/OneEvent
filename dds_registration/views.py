...
def events_list(request, events, context, show_archived=False):
    ...
    return render(request, "dds_registration/events_list.html", context)
...
def booking_create_on_behalf(request, event_id):
    ...
    if form.is_valid():
        ...
        return render(request, "dds_registration/booking_create_on_behalf.html", context)
...
def _booking_update_session(request, booking, form_target_url):
    ...
    if session_form.is_valid():
        ...
        return render(request, "dds_registration/booking_update_with_sessions.html", context)
...
def _booking_update_with_sessions(request, booking):
    ...
    if any(
        ...
        if choices_form.is_valid():
            ...
            return render(
                request, "dds_registration/booking_update_with_sessions.html", context
            )
    else:
        # No Choice to handle
        return _booking_update_finished_redirect(request, booking, "Session")
...
def _booking_update_no_session(request, booking):
    ...
    context = {"booking": booking, "choices_form": choices_form}
    return render(request, "dds_registration/booking_update.html", context)
...
def booking_cancel(request, booking_id):
    ...
    if request.method == "POST":
        ...
        return render(request, "dds_registration/booking_cancel.html", {"booking": booking})
...
def event_manage(request, event_id):
    ...
    return render(request, "dds_registration/event_manage.html", context)
...
def _event_edit_form(request, event):
    ...
    return render(request, "dds_registration/event_update.html", template_context)
...
def _choice_edit_form(request, choice):
    ...
    return render(request, "dds_registration/choice_edit.html", context)
...
def choice_delete(request, choice_id):
    ...
    if request.method == "POST":
        ...
        timezone.activate(choice.event.timezone)
        return render(request, "dds_registration/choice_delete.html", {"choice": choice})
...
def booking_payment_confirm(request, booking_id, cancel=False):
    ...
    if request.method == "POST":
        ...
        return render(request, "dds_registration/booking_payment_confirm.html", context)
...
def booking_payment_exempt(request, booking_id, cancel=False):
    ...
    if request.method == "POST":
        ...
        timezone.activate(booking.event.timezone)
        context = {"booking": booking, "cancel": cancel}
        return render(request, "dds_registration/booking_payment_exempt.html", context)
...
def booking_send_invite(request, booking_id):
    if settings.dds_registration_CALENDAR_INVITE_FROM is not None:
        booking = get_object_or_404(Booking, id=booking_id)
...
def user_delete(request):
    if request.method == "POST":
        ...
        return render(request, "dds_registration/user_delete.html")
