...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventChoiceOption.title'
        db.alter_column(u'OneEvent_eventchoiceoption', 'title', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'EventChoiceOption.title'
        db.alter_column(u'OneEvent_eventchoiceoption', 'title', self.gf('django.db.models.fields.CharField')(max_length=64))
