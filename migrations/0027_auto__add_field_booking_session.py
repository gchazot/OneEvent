...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Booking.session'
        db.add_column(u'OneEvent_booking', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bookings', null=True, to=orm['OneEvent.Session']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Booking.session'
        db.delete_column(u'OneEvent_booking', 'session_id')
    ...
    models = {
        u'OneEvent.booking': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bookings'", 'null': 'True', 'to': u"orm['OneEvent.Session']"})
        },
        ...
        u'OneEvent.event': {
            ...
            'max_participant': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
        ...
        u'OneEvent.session': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sessions'", 'to': u"orm['OneEvent.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_participant': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'})
