...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        bookings = orm['OneEvent.ParticipantBooking'].objects.filter(cancelledBy__isnull=True)
        bookings.update(confirmedOn=timezone.now())

    def backwards(self, orm):
        "Write your backwards methods here."
        bookings = orm['OneEvent.ParticipantBooking'].objects.all()
        bookings.update(confirmedOn=None)
