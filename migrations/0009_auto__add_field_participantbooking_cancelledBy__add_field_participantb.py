...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantBooking.cancelledBy'
        db.add_column(u'OneEvent_participantbooking', 'cancelledBy',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cancelled_bookings', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ParticipantBooking.cancelledOn'
        db.add_column(u'OneEvent_participantbooking', 'cancelledOn',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipantBooking.cancelledBy'
        db.delete_column(u'OneEvent_participantbooking', 'cancelledBy_id')

        # Deleting field 'ParticipantBooking.cancelledOn'
        db.delete_column(u'OneEvent_participantbooking', 'cancelledOn')
