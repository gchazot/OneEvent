...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.price_for_employees'
        db.add_column(u'OneEvent_event', 'price_for_employees',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'Event.price_for_contractors'
        db.add_column(u'OneEvent_event', 'price_for_contractors',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'Event.price_currency'
        db.add_column(u'OneEvent_event', 'price_currency',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.price_for_employees'
        db.delete_column(u'OneEvent_event', 'price_for_employees')

        # Deleting field 'Event.price_for_contractors'
        db.delete_column(u'OneEvent_event', 'price_for_contractors')

        # Deleting field 'Event.price_currency'
        db.delete_column(u'OneEvent_event', 'price_currency')
